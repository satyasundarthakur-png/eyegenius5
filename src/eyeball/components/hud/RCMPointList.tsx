...
export function RCMPointList() {
  ...
  return (
    <div className="pointer-events-auto absolute top-16 right-4 z-10 w-[190px] rounded-lg border border-blue-500/30 bg-gray-950/85 p-3 text-blue-100 backdrop-blur">
